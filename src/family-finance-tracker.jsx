...
// ─── Portfolio Tab ────────────────────────────────────────────────────
function PortfolioTab({ portfolioData, investmentsData, incomeData, rsuData, fy, onUpdate, liveData }) {
  ...
  return (
    <div style={{ minHeight:"100vh", background:T.bg, color:T.text, fontFamily:"'DM Sans',-apple-system,sans-serif" }}>
      ...
      <div style={{ maxWidth:"1400px", margin:"0 auto", padding:"20px" }}>
        ...
        {activeTab==="portfolio"&&<PortfolioTab portfolioData={portfolioData} investmentsData={investmentsData} incomeData={incomeData} rsuData={rsuData} fy={fy} onUpdate={updatePortfolio} liveData={liveData}/>}
      </div>
